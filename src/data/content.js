  ...
  acts: [
    {
      ...
      narrative: [
        { type: 'text', content: 'Mine began in a home where my dreams were given space to breathe. They were explored, encouraged, and sometimes brought to life, but they were never dismissed as unrealistic.' },
        { type: 'text', content: 'My mother gave me one of the greatest gifts of all. She taught me to read by the age of 3. The books I read and the characters I came to know have been a source of comfort and joy my entire life. When I was little, I disappeared into fairy tales where courage mattered, kindness won, and ordinary people accomplished extraordinary things. Those stories opened worlds beyond my own. Books became my lifelong companion, and my love for reading has never dissipated. As long as you have a story to read, one can never be bored or lonely. In fact, I start every day reading for a few hours. To me it\'s my own form of meditation. I tune out the world for a few hours while I centre myself for a new day.' },
        { type: 'text', content: 'When I was about six years old, my parents gave me the gift of expression.' },
        { type: 'emphasis', content: 'They let me design my own bedroom.' },
        { type: 'text', content: 'Of course it was going to be purple.' },
        { type: 'text', content: 'I chose lavender walls, deep purple carpet, and a beautiful white canopy bed any princess would be happy to sleep in. To anyone else it was simply a little girl\'s bedroom.' },
        { type: 'text', content: 'To me, it was a castle where dreams were born. The only thing missing was a puppy. That would come next.' },
        { type: 'text', content: 'My father was the ultimate dreamer. Other people\'s reality never became his.' },
        { type: 'text', content: 'More importantly, the belief he had in himself allowed him to be the architect of his dreams, each one became grander than the next as they became reality.' },
        { type: 'text', content: 'Through hard work, determination, and unwavering belief, he proved himself right.' },
        { type: 'emphasis', content: 'He gave me that same gift.' },
        { type: 'text', content: 'He never measured my dreams against what seemed practical. He never told me to be realistic or to dream smaller because I was a girl.' },
        { type: 'text', content: 'Instead, he taught me to believe in myself and in my ability to make my dreams come true. He gave them space to breathe. He understood that they would either dissipate or grow in intensity.' },
        { type: 'text', content: 'When I was eight years old, my father promised his horse-crazy daughter that when she turned ten, he\'d buy her a horse.' },
        { type: 'text', content: 'There was just one tiny problem. Horses don\'t fit very well in suburban backyards. You can\'t have a horse without a farm.' },
        { type: 'text', content: 'So, every weekend, the two of us climbed into the car and drove through the countryside looking at properties. He dreamed of rolling hills that reminded him of the English countryside where he had worked as a young immigrant. I dreamed about the horse that would one day be waiting for me.' },
        { type: 'text', content: 'Eventually, we found the farm, and soon after he kept his promise.' },
        { type: 'text', content: 'One day I came home to see a beautiful white gelding with striking blue eyes and the gentlest soul imaginable waiting for me. He was such a gentleman and so I named him Cavalier.' },
        { type: 'text', content: 'He wasn\'t simply my horse. He was my friend.' },
        { type: 'text', content: 'He was also a joker with a sense of humour only a horse could appreciate.' },
        { type: 'text', content: 'Years later, I realized that the greatest gift wasn\'t Cavalier. Although, he was pretty wonderful.' },
      ...
      narrativePart3: [
        ...
        { type: 'text', content: 'During this time, another \u2018believer\u2019 entered my life.' },
        { type: 'text', content: 'My parents had sent me to Havergal College, a private girls school, reminiscent of an English Boarding School. My English teacher, Mrs. Loughty, saw potential in me before I fully saw it in myself.' },
        { type: 'emphasis', content: 'She taught me tenacity, but at the time, I called it a \u2018D\u2019.' },
        { type: 'text', content: 'She taught me that talent alone wasn\'t enough. After so many D\'s I certainly didn\'t think I had any. However, I do know that to be a great writer is to be a great reader and I was really good at that.' },
        { type: 'text', content: 'Hard work mattered.' },
        { type: 'text', content: 'Discipline mattered.' },
        { type: 'text', content: 'Staying the course mattered.' },
        { type: 'text', content: 'I didn\'t know it, and maybe she didn\'t either, but her extraordinary efforts prepared me for university, and more importantly, she prepared me for life.' },
        { type: 'text', content: 'The day I received an A in her class felt like winning Olympic gold. I had finally won her respect, and that really meant something.' },
        ...
        { type: 'emphasis', content: 'One taught me that belief without perseverance remains only potential.' },
        { type: 'text', content: 'Life, of course, had plans of its own.' },
        { type: 'text', content: 'Those childhood dreams quietly slipped into the background.' },
        { type: 'emphasis', content: 'Or so I thought.' },
        { type: 'text', content: 'Years later, I discovered they had never really left me.' },
        { type: 'text', content: 'I became an author in my late 40\u2019s.' },
        { type: 'text', content: 'I found my voice behind a microphone in 2007.' },
        { type: 'text', content: 'I discovered painting and became a professional artist in my fifties.' },
        { type: 'text', content: 'My love for animals never faded. It simply found new ways to express itself.' },
        { type: 'text', content: 'Years of coaching people through reinvention taught me something remarkable.' },
        { type: 'emphasis', content: 'Our childhood dreams don\u2019t disappear. They simply wait for us to remember them. Midlife isn\u2019t about finding yourself. It\u2019s about returning to the parts of yourself you left behind.' },
        { type: 'text', content: 'Looking back, I realize my father didn\u2019t just give me a horse, and Mrs. Loughty didn\u2019t just teach me English.' },
        { type: 'emphasis', content: 'They gave me the confidence to become the architect of my own life.' },
        { type: 'centered', lines: ['A builder.', 'A believer.', 'And someone who would spend the rest of her life helping other people believe in themselves.'] },
        { type: 'text', content: 'Because when someone believes in you, they don\'t just change your future, they change your idea of what\'s possible.' },
        { type: 'emphasis', content: 'Every meaningful thing I\u2019ve ever built was the direct result of someone\u2019s belief in me, even if that someone was me.' },
        { type: 'text', content: 'Love expressed through belief has the power to change a life.' },
      ],
