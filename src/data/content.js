export const content = {
  ...
  acts: [
    ...
    },
    {
      ...
      books: {
        ...
        other: [
          { title: 'For Want of 40 Pounds', year: 'International Bestseller', description: 'A compelling narrative exploring transformation and the power of small changes.', cover: '/images/book-for-want-of-40-pounds-cover.jpg', pullQuote: 'Transformation begins with a single decision to change.' },
          ...
          { title: 'No Bull Allowed', year: 'Published', description: 'A direct, no-nonsense guide to living authentically and leading with integrity.', cover: '/images/book-no-bull-allowed-cover.jpg', pullQuote: 'Authenticity is the one thing you can never lose by being yourself.' },
    ...
    },
    {
      ...
      intro: 'If the first seven acts taught Frankie anything, it is that she is terrible at standing still. G-Woman Media launched, acting called, social impact continued — and retirement went very badly.',
      heartbeatLine: 'I am no longer interested in becoming only one thing.',
      frankieism: 'I do stuff like this.',
  ...
  testimonials: {
    ...
    items: [
      {
        quote: 'As my coach, she has instructed, inspired and ingrained in me the will to be unstoppable. It was always there, but I couldn\'t find it… and Frankie helped me find it so I could be the best possible in both my personal and professional life.',
        name: 'Sandra Beck',
      ...
      {
        quote: 'Frankie is rare and special because she pours herself into the moment when she is on air AND because she has so clearly poured herself into the research and preparation before the show. She is vibrant, alive, smart, and dedicated in a way that makes her truly a stand-out in her field.',
        name: 'Anna Huckabee Tull',
        role: 'Founder, Custom Crafted Songs',
        initials: 'AT',
        accent: '#DF3CB5',
        category: 'interviewer',
      },
      {
        quote: 'As the Founder & Chairman of BNI, I do hundreds of interviews a year. That said, being a guest on Frankie Picasso\'s show was one of the most enjoyable interviewing experiences I\'ve had yet.',
        name: 'Ivan Misner',
        role: 'NY Times Bestselling Author, Founder of BNI',
        initials: 'IM',
        accent: '#01B2D4',
        category: 'interviewer',
      },
      {
        quote: 'I really admire Frankie\'s hands on approach. She went straight to the matter of things: get in action! No argues. So I did and that was exactly what I needed. No more whining and thinking about it but a pro-active attitude.',
        name: 'Peggy Saman',
        role: 'Coaching Client, The Netherlands',
        initials: 'PS',
        accent: '#629E46',
        category: 'coaching',
      },
      {
        quote: 'A natural communicator, Frankie is not only a gifted listener, but an inspirational speaker. Frankie captures her audience with her energy — it\'s captivating, intriguing and powerful. You listen when Frankie speaks and leave the conversation wanting more.',
        name: 'Danielle Vandale',
