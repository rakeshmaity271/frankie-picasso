import { navLinks, content } from '../../data/content'
    ...
    <footer className={styles.footer}>
      ...
      <div className={`container ${styles.inner}`}>
        <div className={styles.brand}>
          <img src="/logo.png" alt="" className={styles.footerLogo} aria-hidden="true" />
          ...
          <p className={styles.websiteUrl}>frankiepicasso.com</p>
        </div>
